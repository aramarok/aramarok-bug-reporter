...
public enum Right {
	...
	EDIT_PREFERENCES, //allow user to edit it's profiles preferences
	CHANGE_BUG_STATUS, //allow user to change the status of the bug
	ADD_BUG_COMMENT, //allow user to add a bug comment
	EDIT_BUG, //allow user to edit bugs information
